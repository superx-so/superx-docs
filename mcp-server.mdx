...
For the tool chains behind a whole job (a weekly recap, a week of posts, a queue reshuffle, a DM campaign), see [Agent playbooks](/playbooks): 29 recipes, each naming the tools to call in order and where the chain stops.
