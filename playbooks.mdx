...
description: "Twenty-eight goal-shaped recipes, one per SuperX skill, each with its CLI chain, its MCP tool chain, and the point where it hands back to a person."
---
...
all twenty-eight: a post is a DRAFT unless someone asked for it to be scheduled
